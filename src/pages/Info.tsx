    ...
    <AppLayout>
      <div className={`container mx-auto px-4 py-8 opacity-0 ${showAnimation ? 'animate-fade-in' : ''}`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="glass p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-xl font-semibold select-none">Místo konání</h2>
              </div>
              <p className="mb-2 select-none"><strong>Kulturní Dům....</strong></p>
              <p className="text-gray-600 mb-1 select-none">Ulice Obecná 12345</p>
              <p className="text-gray-600 mb-1 select-none">363 01 Ostrov</p>
              <p className="text-gray-600 select-none">Akce se koná v nějké aule</p>
            </div>
            ...
            <div className="glass p-6 rounded-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h2 className="text-xl font-semibold select-none">Datum a čas</h2>
              </div>
              <p className="mb-2 select-none"><strong>Pátek, 12. Březena 2044</strong></p>
              <p className="text-gray-600 mb-1 select-none">Začátek: 17:00</p>
              <p className="text-gray-600 select-none">Předpokládaný konec: 19:00</p>
            </div>
          </div>
          
          <div className="mb-10">
            <h2 className="text-2xl font-bold mb-5 select-none">Mapa</h2>
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold mb-5 select-none">Často kladené otázky</h2>
            <div className="bg-white/50 rounded-2xl p-1">
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  <AccordionTrigger className="px-5 py-4 hover:bg-purple/5 rounded-xl select-none">
                    Je účast na rozlučce povinná?
                  </AccordionTrigger>
                  <AccordionContent className="px-5 pb-4 select-none">
          ...
          <div className="glass p-6 rounded-2xl">
            <h2 className="text-2xl font-bold mb-4 select-none">Kontakt</h2>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                <h3 className="font-semibold mb-2 select-none">Třídní učitelka</h3>
                <p className="text-gray-600 mb-1 select-none">Mgr. Jaroslava Piherová</p>
                <p className="text-gray-600 mb-1 select-none">E-mail:</p>
                <p className="text-gray-600 select-none">Tel.:</p>
              </div>
              
              <div className="flex-1">
                <h3 className="font-semibold mb-2 select-none">Zástupce třídy</h3>
                <p className="text-gray-600 mb-1 select-none">David Vreštiak, protože je na něj největší spoleh xDD</p>
                <p className="text-gray-600 mb-1 select-none">E-mail:</p>
                <p className="text-gray-600 select-none">Tel.:</p>
              </div>
            </div>
