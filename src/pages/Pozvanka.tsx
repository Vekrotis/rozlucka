...
function useGenderGradient(): string {
  ...
  if (gender === 'muz' || gender === 'muž') return 'from-blue-500 via-blue-400 to-cyan-400';
  if (gender === 'zena' || gender === 'žena') return 'from-pink-500 via-rose-400 to-pink-400';
  return 'from-yellow-400 via-yellow-300 to-orange-300';
}
