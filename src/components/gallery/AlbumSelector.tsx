...
const AlbumSelector: React.FC<AlbumSelectorProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="album-selector-dialog bg-white/95 backdrop-blur-sm border border-white/30 p-6 max-w-lg mx-auto md:rounded-xl rounded-2xl max-h-[80vh] overflow-hidden flex flex-col">
        <button 
          onClick={onClose}
